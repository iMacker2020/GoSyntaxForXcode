...
The included installer is a fat-binary. It contains binaries for both x86_64 and ARM64 (Sorry i386 and PowerPC users). To use it simply double-click on it in the Finder. Once it is done restart Xcode (if it was open) and open a .go file. 
